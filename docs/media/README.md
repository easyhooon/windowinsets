...
These GIFs were refreshed on 2026-09-24 from the local production build containing
rigid fold housings, capture-relative hinges and the shared measurement rulers.
